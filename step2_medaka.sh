...
#medaka (https://github.com/nanoporetech/medaka) is a tool that allows you to polish your draft assembly using your own reads. It is an important step into polishing the assembly. 
...
conda activate Assembly #this is the environment in which I have medaka installed. 
#For running this I have to have installed minimap2 and samtools!

#input
reads="path/to/your/reads.fastq.gz" #path to fastq files with raw reads
assembly="assembly.fasta" #path to draft genome, in this case the one I generated with flye
